...
if __name__ == '__main__':
    ...
    # SCP.train_semi_finished_SiamCBAMUNet(os.path.abspath("computational_graphs/SiamCBAMUNet/SiamAttenUNet_ep220_loss1.983.pt"), os.path.abspath("computational_graphs/SiamCBAMUNet/"), 220)
    # SCP.evaluate_SiamCBAMUNet(os.path.abspath("computational_graphs/SiamCBAMUNet/SiamAttenUNet_ep220_loss1.983.pt"), False)